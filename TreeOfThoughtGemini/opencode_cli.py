...
class ACPClient:
    ...
    to the OpenCode CLI via JSON-RPC 2.0 over standard input/output.
    """
    def __init__(self, cli_args: List[str] = None):
        if cli_args is None:
            # Enable ACP mode natively for OpenCode
            cli_args = ["opencode", "acp"]
        ...
        try:
            ...
            raise ACPClientError("Failed to execute OpenCode CLI. Ensure 'opencode' is in the system PATH.")
    ...
    def _authenticate_protocol(self):
        ...
        For OpenCode, authentication is handled out-of-band via its CLI context.
        """
        # Kept as a pass-through in case OpenCode adds strict ACP auth requirements later.
        pass
...
def main():
    ...
    print("==================================================")
    print("         OpenCode ACP Chat & ToT Harness          ")
    print("==================================================")
